...
// This function was completely re-coded to get rid of useless nested functions, duplicated switch
// blocks, and unneeded calculations, and extra computations inside the for loop.  In the end, all
// we care about is to apply a small, medium or large class to the elements.
var resizePizzas = function (size) {
    window.performance.mark("mark_start_resize");   // User Timing API function

    // This variable will hold the string for the new width.
    var newClass = '';
